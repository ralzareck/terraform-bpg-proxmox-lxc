# Example 02: Basic Template

The 02-basic-template example uses the terraform-bgp-proxmox-vm module to deploy single LXC container to a proxmox server using a tar.xz LXC image as base.
